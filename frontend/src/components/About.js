...
const About = () => {
  return (
    <div>
      ...
      {/* About us */}
      <div className="relative pt-[120px] md:pt-[180px] lg:pt-24 lg:py-12">
        <h1
        ...
        <div className="space-y-4">
          <div
            className="text-white text-xl rounded-md mb-[2px] px-4 md:text-4xl lg:text-2xl "
            style={{
              textShadow:
          ...
          >
            <h1>Opening Hours: Open:-1:00 PM --- Close:-11:00 PM (Daily)</h1>
          </div>

          <div
            className="text-xl text-white rounded-md mb-[2px] px-4 md:text-4xl lg:text-2xl"
            style={{
              textShadow:
                "1px 1px 0 black, -1px 1px 0 black, 1px -1px 0 black, -1px -1px 0 black",
            }}
          ...
          >
            <h1>
              Email: clearbusinessbyadrian
              <br className="md:hidden lg:hidden"></br>@gmail.com
            </h1>
          </div>
