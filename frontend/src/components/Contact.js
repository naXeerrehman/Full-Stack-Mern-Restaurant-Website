...
const Contact = () => {
  ...
  return (
    <div>
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col lg:flex-row justify-center items-center min-h-screen pt-7 pb-10 px-4">
        {/* Icons Section */}
        ...
        {/* Form Section */}
        <div className="w-full lg:w-1/2 max-w-xl lg:px-4">
