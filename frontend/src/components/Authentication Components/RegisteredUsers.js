...
const Registeredusers = () => {
  ...
  return (
    <div className="mx-auto mt-[16px] w-full text-white md:text-2xl lg:text-xl px-0 md:px-3">
      <h2 className="bg-red-600 text-white text-xl md:text-2xl rounded-md p-3 font-semibold text-center lg:text-md max-w-lg mx-auto">
        Registered Users
      </h2>
      <ul>
        {isLoading ? (
              ...
              users.map((user) => (
                ...
                >
                  {editingUser === user._id ? (
                    // Edit inputs
                    <div className="flex flex-col gap-y-1 -mt-[40px]">
                      <input
                        type="text"
                        value={updatedName}
                        onChange={(e) => setUpdatedName(e.target.value)}
                        placeholder="Enter new name"
                        className="p-1 text-xl rounded-md text-black"
                      />
                      <input
                        type="email"
                        value={updatedEmail}
                  ...
                  <div className="flex flex-col md:flex-row lg:flex-row mt-[30px]">
                    {editingUser === user._id ? (
                      ...
                      <>
                        <button
                          ...
                          className="border px-2 py-1 rounded-md text-white flex-1 w-[80px] md:w-[100px]  lg:w-[60px] text-sm bg-green-500 mb-2"
                        >
                          Save
                        </button>
                        <button
                      ...
                      <button
                        ...
                        className="w-[100px]  lg:w-[60px] border rounded-md text-white text-center flex-1 text-sm mb-2 bg-yellow-500"
                      >
                        Edit
                      </button>
                    )}
                    <div className="flex flex-col md:flex-row space-x-2 items-center">
                      <button
                        ...
                        className="border px-2 rounded-md text-white flex-1 w-[100px]  lg:w-[60px] h-[30px] text-sm mb-2 bg-red-600 md:ml-1"
                      >
                        Delete
                      </button>
                      ...
                      <button
                        ...
                        className={`border rounded-md text-white flex-1 w-[100px] lg:w-[180px] px-1/2 md:w-[190px] md:h-[30px] text-sm mb-2 ${
