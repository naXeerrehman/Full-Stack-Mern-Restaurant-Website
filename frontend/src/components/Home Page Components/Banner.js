...
import DisplaySocialMediaIcons from "../Home Page Components/DisplaySocialMediaIcon";
...
const Banner = () => {
  ...
  return (
    <div className="overflow-hidden lora-naxeer">
      {/* Background Image */}
      <img
        src={FastFood}
      ...
      <div className="flex flex-col md:flex-col lg:flex-row justify-center items-center relative mx-auto px-4 mt-[50px] lg:mt-[80px]">
        ...
        <div className="w-full md:w-full px-4 text-center lg:mt-[50px]">
          <h1
            className="text-3xl md:text-5xl lg:text-6xl xl:text-6xl font-semibold text-white leading-tight xl:leading-tight"
            style={{
              textShadow:
          ...
          <h1
            className="text-2xl md:text-4xl lg:text-5xl xl:text-5xl font-semibold text-white leading-tight xl:leading-tight"
            style={{
              textShadow:
                "2px 2px 0 black, -2px 2px 0 black, 2px -2px 0 black, -2px -2px 0 white",
            }}
        ...
        {/* Buttons Section */}
        <div className="flex flex-col space-y-6 md:space-y-8 lg:space-y-10 xl:space-y-12 w-full justify-center items-center mt-8 md:mt-5 lg:mt-12 xl:mt-14">
