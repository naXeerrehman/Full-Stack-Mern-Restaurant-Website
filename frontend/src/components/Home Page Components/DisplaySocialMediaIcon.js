...
const DisplaySocialMediaIcons = () => {
  ...
  return (
    <div className="w-[80%] h-[150px] md:h-[210px] lg:h-[190px] pt-[40px] mx-auto z-[10] md:pt-[100px] lg:pt-[120px] relative">
              ...
              <div>
                ...
                >
                  <img
                    ...
                    alt={socialIcon.link}
                    className="w-[7vw] h-[7vw] max-w-[60px] md:h-[60px] md:w-[60px] lg:w-[40px] lg:h-[40px] rounded-full transition-transform duration-300 hover:-translate-y-[30%] ml-2.5 md:ml-1 lg:ml-[7px]"
                  />
                </a>
                {isLoggedIn && isAdmin && (
                  <div className="py-1 w-full flex justify-center gap-2">
                    ...
                    >
                      <FaRegEdit className="ml-[3px] md:-mt-[2px]" />
                    </button>
                    <button
