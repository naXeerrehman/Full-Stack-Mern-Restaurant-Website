...
const SocialMediaIconManagement = () => {
  ...
  return (
    <div className="mt-[16px] w-full text-white md:text-2xl lg:text-xl">
      <h2 className="bg-red-600 text-white text-xl md:text-2xl rounded-md p-1 font-semibold text-center lg:text-md">
      ...
      <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-4 mt-2">
              <div className="relative">
                <img
                  ...
                  alt="preview"
                  className="w-[100px] h-[80px] md:h-[100px] md:w-[100px] lg:h-[80px] lg:w-[80px] rounded-md"
        ...
        <div className="flex flex-col">
          <h1 className="bg-red-600 text-white text-xl md:text-2xl rounded-md p-1/2 w-[100px] md:w-[150px] mt-1 font-semibold text-center lg:text-md">
            Pro Tips:
          </h1>
          <div className="space-y-2 md:text-3xl lg:text-2xl">
            ...
            <h1>
              ...
              <br />
              <span className="text-white bg-black opacity-70 rounded-md overflow-hidden whitespace-nowrap text-wrap md:text-3xl lg:text-2xl">
                https://mail.google.com/mail/?view={" "}
                <br className="block lg:hidden"></br>cm& to=YOUR_EMAIL
              </span>
